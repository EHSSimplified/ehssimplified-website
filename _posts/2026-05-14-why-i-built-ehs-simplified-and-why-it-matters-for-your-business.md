...
date: 2026-05-14T23:09:24.934Z
author: Aaron Leff, CSP
topic: General EHS
summary: "After 25 years in Environmental Health & Safety, I kept seeing the
  same problem: small businesses that wanted to do right by their people but had
  no practical tools to make it happen. That's why I built EHS Simplified — a
  mobile safety app designed specifically for small trade and manufacturing
  businesses. In this first post, I share what the app does, why the cost of
  ignoring safety is never zero, and what you can expect from this blog going
  forward."
---
<!--StartFragment-->
...
*Aaron Leff is a Certified Safety Professional (CSP) with 25+ years of EHS experience and the founder of EHS Simplified. He works with small businesses across construction, manufacturing, food service, and more to build safety programs that actually get used.*

*Ready to see the app? [Launch the live demo](https://app.ehssimplified.com/) — no login required.*
